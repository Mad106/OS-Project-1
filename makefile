...
shell: parser.o prompt.o echo.o tilde.o path.o evariables.o bgjobs.o cd.o piping.o exit.o 
	$(CC) $(FLAGS) -o shell parser.o prompt.o echo.o tilde.o path.o evariables.o bgjobs.o cd.o piping.o exit.o
